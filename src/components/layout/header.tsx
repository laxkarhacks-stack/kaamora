          ...
          {loading ? (
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 rounded-lg bg-zinc-100 px-3 py-1.5 text-sm font-medium text-zinc-800 hover:bg-zinc-200 dark:bg-zinc-800 dark:text-zinc-100 dark:hover:bg-zinc-700"
              >
              ...
              {menuOpen && (
                <>
                  ...
                  <div className="absolute right-0 z-50 mt-2 w-48 rounded-xl border border-zinc-200 bg-white py-1 shadow-lg dark:border-zinc-700 dark:bg-zinc-900">
                    ...
                    <button
                      type="button"
                      className="block w-full px-4 py-2 text-left text-sm text-red-600 hover:bg-zinc-50 dark:hover:bg-zinc-800"
                      onClick={() => {
                        setMenuOpen(false);
                        void logout();
                      }}
